...
<style>
    ...
    .header-bg{
        ...
        background-image: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url({{ Storage::disk('public')->url('category/'.$category->image) }});
...
@section('main-body')
    ...
    <div class="header-bg">
        <div class="slider display-table center-text">
            <h1 class="title display-table-cell">{{ $category->name }}</h1>
        </div>
    </div>
                        ...
                        <div class="card h-100">
                            <div class="single-post post-style-1"> 
                                ...
                                <div class="blog-info pt-5">                    
                                    <h4 class="title"><strong>Sorry, No posts found in this Category :(</strong></a>
                                    </h4> 
                                </div><!-- blog-info -->
                            </div><!-- single-post -->
                        </div><!-- card -->
