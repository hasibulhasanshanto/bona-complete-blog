...
@push('css') 
    <link href="{{ asset('/frontend/css/author/styles.css')}}" rel="stylesheet">
    <link href="{{ asset('/frontend/css/author/responsive.css')}}" rel="stylesheet">
<style>
    .favorite_posts {
        color: red;
    }
...
@section('main-body')
    ...
    <div class="header-bg">
        <div class="slider display-table center-text">
            <h1 class="title display-table-cell">{{ $author->name }}</h1>
        </div>
    </div>
                            ...
                            <div class="card h-100">
                                <div class="single-post post-style-1">
                                    ...
                                    <div class="blog-info pt-5">
                                        <h4 class="title"><strong>Sorry, No posts found in this tag :(</strong></a>
                                        </h4>
                                    </div><!-- blog-info -->
                                </div><!-- single-post -->
                            </div><!-- card -->
                ...
                <div class="col-lg-4 col-md-12 ">                        
                    <div class="single-post info-area ">
                        ...
                        <div class="about-area">
                            ...
                            <h5><b>{{ $author->name }}</b></h5><br>
                            <p>{{ $author->about }}</p><br>
                            <span><b>Joined in : {{ $author->created_at->toDateString()}}</b></span><br>
                            <span><b>Number of posts : {{ $author->posts->count()}}</b></span><br>
                        </div>  
