            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="body">
                    <ol class="breadcrumb breadcrumb-bg-purple align-right">
                        <li><a href="javascript:void(0);"><i class="material-icons">dashboard</i>Author's Dashboard</a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-pink hover-expand-effect">
                    ...
                    <div class="number count-to" data-from="0" data-to="{{ Auth::user()->posts->count() }}" data-speed="15"
